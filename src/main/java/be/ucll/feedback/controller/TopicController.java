...
public class TopicController {
    ...
    public Topic getSpecificTopicById(@PathVariable("foo") int id) {
    ...
    public void editSpecificWholeTopic(@PathVariable("id") int id, @RequestBody @Valid Topic changedTopic) {
